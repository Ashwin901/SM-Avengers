            ...
            {loading ? <Loading /> :
                <div className="new-post-div">
                    ...
                    <Form className="form-div" onSubmit={handleSubmit}>
                        <div class="img-div">
                            <Button className="upload-button" variant="dark" onClick={() => { inputRef.current.click() }} type="button">
                        ...
                        <Button className="new-post-button" type="submit" variant="dark">Create new post</Button>
                    </Form>
                </div>}
        </>
